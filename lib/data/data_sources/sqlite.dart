...
class DataBaseHelper {
  ...
  String cart =
      "create table cart (id INTEGER PRIMARY KEY AUTOINCREMENT UNIQUE, userId INTEGER , product TEXT NOT NULL, description TEXT NOT NULL, amount REAL,  createdAt INTEGER ,FOREIGN KEY (userId) REFERENCES users(userId))";
  String addCart =
  ...
  Future<int> createCartItem(CartModel cartItem, int userId) async {
    ...
    cartItem.createdAt = DateTime.now().millisecondsSinceEpoch;
